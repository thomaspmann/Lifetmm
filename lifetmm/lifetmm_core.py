...
class LifetimeTmm:
    ...
    def time_fwd_coeff(self, layer, radiative):
    ...
    def time_rev_coeff(self, layer, radiative):
    ...
    def structure_E_field(self, time_rev=False, radiative='Lower'):
        ...
        for layer in range(self.num_layers):
            ...
            E_layer = self.layer_E_field(layer=layer, time_rev=time_rev, radiative=radiative)['E']
            E[z_indices] = E_layer
        E_square = abs(E)**2
