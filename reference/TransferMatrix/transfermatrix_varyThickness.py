...
thicknesses = [0, 1000, 100, 300000, 0]     # in nm

activeLayer = 1  # indexing starts from 0
layerVaried = 1  # indexing starts from 0

varyStart = 50  # starting thickness of the layer to be varied (nm)
varyFinish = 2000  # final thickness of the layer to be varied (nm)
varyStep = 50  # thickness increments (nm)

lambda_start = 1500  # build a wavelength range to calculate over, starting wavelength (nm)
lambda_stop = 1500  # final wavelength (nm)
lambda_step = 1  # wavelength step size

x_step = 100.0  # grid spacing of device cross section simulation in nm
